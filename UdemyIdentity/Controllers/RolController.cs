...
namespace UdemyIdentity.Controllers
{
    ...
    public class RolController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> UpdateRole(RolUpdateViewModel model)
        {
        ...
        {
            var user = _userManager.Users.FirstOrDefault(I => I.Id == id); // id ile gelen kullanıcıyı çek
            TempData["UserId"] = user.Id;
            var roles = _roleManager.Roles.ToList(); // tüm rolleri listele çek
            var userRoles = await _userManager.GetRolesAsync(user); // kullanıcının rollerini çek
